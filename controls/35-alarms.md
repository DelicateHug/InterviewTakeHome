...
- **Alert:** Any alarm → SNS [36] (3 already fired on real activity during the build).

## What would trigger an alert

Each alarm watches for one concrete action — all route to SNS [36]:
...
- A blocked read on the sensitive bucket [20] → `s3-access-denied`
